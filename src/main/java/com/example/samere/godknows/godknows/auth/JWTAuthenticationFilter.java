...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest req,
        ...
        try {
            com.example.samere.godknows.godknows.entity.User creds = new ObjectMapper()
                    .readValue(req.getInputStream(), com.example.samere.godknows.godknows.entity.User.class);
